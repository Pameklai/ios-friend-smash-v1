...
namespace FriendSmasher
{
    namespace Game
    {
        ...
        void FacebookController::SendBrag(const int nScore)
        {
            ...
            NSString *linkURL = [NSString stringWithFormat:@"https://www.friendsmash.com/challenge_brag_%llu", ms_uPlayerFBID];
        ...
        void FacebookController::SendScore(const int nScore)
        {
            ...
            [FBRequestConnection startWithGraphPath:[NSString stringWithFormat:@"%llu/scores", ms_uPlayerFBID] parameters:params HTTPMethod:@"GET" completionHandler:^(FBRequestConnection *connection, id result, NSError *error) {
                ...
                if (result && !error) {
                    ...
                    if (nScore > nCurrentScore) {
                        ...
                        [FBRequestConnection startWithGraphPath:[NSString stringWithFormat:@"%llu/scores", ms_uPlayerFBID] parameters:params HTTPMethod:@"POST" completionHandler:^(FBRequestConnection *connection, id result, NSError *error) {
        ...
        void FacebookController::SendAchievement(eGameAchievements achievement)
        {
            ...
            [FBRequestConnection startWithGraphPath:[NSString stringWithFormat:@"%llu/achievements", ms_uPlayerFBID] parameters:params HTTPMethod:@"POST" completionHandler:^(FBRequestConnection *connection, id result, NSError *error) {
            }];
        }
