...
namespace FriendSmasher
{
    namespace Game
    {
        ...
        void GameController::EndGame()
        {
            ...
            if (m_bShouldSendAchievement[FacebookController::kACHIEVEMENT_SCOREx3]) {
                FacebookController::SendAchievement(FacebookController::kACHIEVEMENT_SCOREx3);
            }
            
            if (m_bShouldSendAchievement[FacebookController::kACHIEVEMENT_SCORE200]) {
                FacebookController::SendAchievement(FacebookController::kACHIEVEMENT_SCORE200);
            }
            else if (m_bShouldSendAchievement[FacebookController::kACHIEVEMENT_SCORE150]) {
                FacebookController::SendAchievement(FacebookController::kACHIEVEMENT_SCORE150);
            }
            else if (m_bShouldSendAchievement[FacebookController::kACHIEVEMENT_SCORE100]) {
                FacebookController::SendAchievement(FacebookController::kACHIEVEMENT_SCORE100);
            }
            else if (m_bShouldSendAchievement[FacebookController::kACHIEVEMENT_SCORE50]) {
                FacebookController::SendAchievement(FacebookController::kACHIEVEMENT_SCORE50);
            }
#endif
